	...
	(function($){
        ...
        dashboard: function (options){
            ...
            return this.each(function() {
					...
					$(document).on('mousedown','.dashboard_bloc_head',function(e){
						dashboard_handle = $(this);
						...
						$(this).on('mouseup',function(){
							...
							dashboard_bloc.removeClass('dashboard_bloc_mouved');
							var sort = {};
							if($('.dashboard_placement.dragover').length>0){
								$('.dashboard_placement.dragover').before(dashboard_bloc);
								sort.column = $('.dashboard_placement.dragover').data('column');
								sort.cell = dashboard_bloc.index();
							}
